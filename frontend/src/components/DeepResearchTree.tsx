...
import { Brain, Cpu, Database, Network, Search, Zap, Lightbulb, Rocket } from "lucide-react";
...
export function DeepResearchTree() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 w-full max-w-4xl mx-auto overflow-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center min-h-[400px] w-full mt-4">
        ...
        <div className="relative flex w-full justify-between px-10 mt-16">
          ...
          <div className="relative flex flex-col items-center w-1/3">
            ...
            <div className="flex justify-center mt-8">
                ...
                >
                  ...
                  <span className="text-[11px] font-medium text-slate-600 bg-white border border-slate-200 px-2 py-0.5 rounded-full shadow-sm">Vector Matching</span>
                </motion.div>
            </div>
          </div>
          ...
          <div className="relative flex flex-col items-center w-1/3">
            ...
            <div className="flex justify-center gap-4 mt-8">
              {['Yellow.ai', 'Wysa', 'Krutrim'].map((startup, i) => (
                <motion.div
                  key={startup}
                  initial={{ opacity: 0, y: -20 }}
                  animate={{ opacity: 1, y: 0 }}
